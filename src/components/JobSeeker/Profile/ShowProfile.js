            ...
            {employee.length == 0 ? (
                ...
                <div className="section_content">
                    <div className="section_top_content">
                        <div className="section_action">
                            <div className="resume-header"><button className="btn btn-success btn-lg " onClick={handleShow}>Add Profile</button></div>
                        </div>
                    </div>
                ...
                <div className="profile-content">
                    <section className="resume-header">
                        <div>                            
                            <h2 className="section_title resume-title">{employee.name}</h2>
                            <p><a href="{employee.portfolio_link}" target="_blank">{employee.portfolio_link}</a></p>
                            <button className="btn btn-primary">Edit</button>
                        </div>
                    </section>
                    <SkillList employee={employee} />
                    <ResumeList employee={employee} />
                    <EducationList employee={employee} />
                </div>
             )}
        </div>
    )
